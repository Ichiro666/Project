...
<template>
    <main class="mt-[80px]">
        <nav
            class="bg-white px-12 pe-24 w-full h-[80px] fixed top-0 z-50 bg-x-black flex items-center justify-between shadow-md"
        >
            <!-- Bagian Kiri: Logo -->
            ...
            <!-- Bagian Kanan: Cart, Profile, Logout -->
            <div class="flex space-x-6 items-center">
                <!-- Link ke halaman Cart -->
                <Link href="/cart" class="text-gray-700 hover:text-green-700">
                    <svg
                ...
                <Link href="/login" class="text-gray-700 hover:text-green-700">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
